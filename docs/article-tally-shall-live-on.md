...
Furthermore, with the rise of xStocks and companies moving their stocks and ownerships onchain, we are closer than ever to seeing public companies native to the blockchain. Their legacy, out-of-date, and severely under-served "proxy voting" systems—which currently rely on phone calls and mail-in ballots—desperately need modern, transparent projects like this.
